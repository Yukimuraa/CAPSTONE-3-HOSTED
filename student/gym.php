					...
					while ($attempts < $maxAttempts && !$success) {
						...
						try {
							if ($stmt->execute()) {
                                ...
                                create_notification($user_id, "Gym Reservation Submitted", "Your gym reservation (ID: {$booking_id}) for {$date_formatted} has been submitted and is pending approval.", "booking", "student/gym.php");
        ...
        <header class="bg-white shadow-sm z-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-gray-700 hidden sm:inline mr-2"><?php echo htmlspecialchars($user_name); ?></span>
